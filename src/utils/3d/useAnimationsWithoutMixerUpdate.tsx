...
export function useAnimationsWithoutMixerUpdate<T extends AnimationClip>(
  clips: T[],
      ...
      Object.defineProperty(actions, clip.name, {
        ...
        get() {
          if (actualRef.current) {
            return (
              (lazyActions.current as any)[clip.name] ||
              ((lazyActions.current as any)[clip.name] = mixer.clipAction(
                clip,
                actualRef.current
              ))
            )
