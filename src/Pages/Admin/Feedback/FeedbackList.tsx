  ...
  return (
    <div>
      <div className="flex justify-end">
        <Link className="btn" to="/admin/feedbacks/create">
          Create
        </Link>
      </div>
      <div>
              ...
              {data.map((item, index) => {
                return (
                  <tr key={`${item.id}-${index}`}>
                    <td>
                      <Label.Text value={item.comment} />
                    </td>
                    <td>
                      <Label.Text value={item.star} />
                    </td>
                    <td>
                      <Label.Text value={item.email} />
                    </td>
                    <td>
                      {/* <Button.Show id={item.id} contentType="feedbacks" /> */}
                      <Button.Edit id={item.id} contentType="feedbacks" />
                      <Button.Delete
                        id={item.id}
                        contentType="feedbacks"
                        onChange={fetchList}
                      />
                    </td>
                  </tr>
